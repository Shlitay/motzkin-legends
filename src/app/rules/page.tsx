  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-5 px-6 pb-24 pt-20">
      ...
      <RuleCard icon={<ClockIcon size={22} />} title="לפני הבעיטה הראשונה">
        נחשו את התוצאה המדויקת של כל 7 המשחקים במחזור. מותר לשנות ניחוש לכל משחק עד הבעיטה הראשונה של המשחקים באותו היום — ברגע שהמשחק הראשון של היום מתחיל, כל משחקי אותו היום ננעלים, אבל אפשר עדיין לעדכן משחקים בימים הבאים עד שהם מתחילים.
      </RuleCard>
